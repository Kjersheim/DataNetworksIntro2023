...
Link ID         ADV Router      Age  Seq#       CkSum  Link count
10.8.83.253     10.8.83.253      825 0x80000013 0xfa9a 6
10.8.83.254     10.8.83.254      771 0x8000000c 0x9e60 4
10.8.83.255     10.8.83.255      773 0x80000008 0x280d 3

                Net Link States (Area 0.0.0.0)

Link ID         ADV Router      Age  Seq#       CkSum
10.8.83.241     10.8.83.253      785 0x80000002 0x09d0
10.8.83.246     10.8.83.255      733 0x80000002 0xe2ed
10.8.83.249     10.8.83.253      825 0x80000002 0xc60a
...
At this point I also change the default cost value in all 3 routers. 
...
As seen, even with 1000 Mbps 1 and 10 Gbps would have the same cost. 
