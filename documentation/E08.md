...
At some point in my testing, the database changed. I am still unaware of why. But previously, both which routers was backup or DR were different. If this came to be due to the change in reference-bandwidth for costs, is not clear to me yet. 
