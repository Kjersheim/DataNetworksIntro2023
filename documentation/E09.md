...
When starting to add the rules, I had a thought of using ssh to configure the router a bit easier, but as there is no connection.. 
...
![](/documentation/E09/enablingfirewallrunes.gif)

*The rendering of this gif almost crashed my stationary office computer that is not ment to have 10 virtual machines open and in addition do stuff it should do to begin with, rendering.*
...
![](/documentation/E09/Lubuntu1ToLWAN_HTTP_works.png)

Ping from Lubuntu2 to Lubuntu WAN:

![](/documentation/E09/Lubuntu2ToWLAN_HTTP_and_ping_works.png)
...
![](/documentation/E09/FirewallLogDeniedL3Traceroute.png)


- [x] Test and verify firewall settings to Router C
 
### Log
 - [Vyos Router C Firewall log, LAN_to_WAN](/documentation/E09/firewalllogs.cfg)
