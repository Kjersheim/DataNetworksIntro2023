...
As an **end note** on this section, I believe that the cost does not decide the root-switch, nor does traffic change due to the cost it self. But - when the switches sends STP information
