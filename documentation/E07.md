...
|Lubuntu2 however remains stable, as it is pinging Lubuntu3 and is entering port2 on SwitchB, before continuing out Port3 towards the path to Lubuntu3.|Lubuntu1 gets its path disrupted, as It originally would prefer travelling from P2 in SwitchA to P1 in SwitchB, but instead needs to take the alternative route via Port3 of SwitchA, to Port1 of SwitchC, then to P2 o |



![](/documentation/E07/disableport1.png)