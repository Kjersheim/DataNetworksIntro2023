...
- [ ] Update and review current topology with STP information
	- [ ] Add Network_Switch_C to the topology, RING-topology
	- [ ] Move lubuntu machine(at this point unclear which) behind Network_Switch_C
...
- To avoid loops, only keep **one** switch powered on at the time. 
