...
Starting up the third Switch, completing the connection of the RING. Immidiately I see that the processor

![](/documentation/E07/StartingSwitchC.gif)

And finally when shutting down Switch C, the processes drop.
