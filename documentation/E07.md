...
|Lubuntu1 to 2|
|----|
|Lubuntu1 gets its path disrupted, as It is bound to prefer travelling from P2 in SwitchA to **P1** in SwitchB, but instead needs to take the alternative route from Port3 of SwitchA to Port3 of SwitchC, and then to Lubuntu2. This is a curious realization, as this is actually the fastest waywith a cost of 6, while through the RP to Root switch it costs 8.|
