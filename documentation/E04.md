...
At this point my plan for the network and working initially on the Logical chart is like the draft below:
![](/documentation/E04/LogicalChart_1.png) 


# Working on both the logical and physical Topology, implementing configurations
...
- Lastly I untag port 2 which goes from Network_Switch_B to Lubuntu 2. \
