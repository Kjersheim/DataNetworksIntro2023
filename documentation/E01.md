...
One "intersection" of the route had a massive packetloss, ranging between 50-80%. Not really understanding this, but trying pathping in windows both on a laptop on the same wifi - and on the stationary machine that hosts the VM.
