...
set service dhcp-server shared-network-name lubuntu1 subnet 192.168.39.0/26 range PCs stop 192.168.25
```
...
set service dhcp-server shared-network-name lubuntu2 subnet 192.168.39.64/26 range PCs stop 192.168.90
```
