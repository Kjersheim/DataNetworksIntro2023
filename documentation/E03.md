...
I did realise there was a function or process called VLSM however not very broadly discussed in the current material. 
...
$`\textcolor{blue}{ \text{network/subnet, 26 bits}\  } `$ $`\textcolor{red}{ \text{host/addresses, 4 bits}\  } `$
...
Supernets are large is the first keyword that came to mind. Setting up the network- and host-bits to get a better overview:

Looking at the addresses:

Decimal: 10.08.83.0/24 | Binary: 0000 1010.0000 1000.0101 0011. 0000 0000
```
Subnet mask: nnnn nnnn.nnnn nnnn. nnnn nnnn. hhhh hhhh
			 1111 1111.1111 1111. 1111 1111. 0000 0000	
```
Decimal: 10.08.16.0/20 | Binary: 0000 1010.0000 1000.0001 0000. 0000 0000

```
Subnet mask: nnnn nnnn.nnnn nnnn. nnnn hhhh. hhhh hhhh
...
When looking at the 12 host-bits used for the addresses in binary form:
| Description | Binary | Decimal |
| -----  | -----   | -----  |
First address | 0000.0000 0000 | 0.00 |
Second address | 0000.0000 0001 | 0.01  |
Second last address | 1111.1111 1110 | 15.254 |
Last address | 1111.1111 1111 | 15.255 |
