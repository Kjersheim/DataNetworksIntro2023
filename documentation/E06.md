...
For the purpose of $`\textcolor{limegreen}{ \text{**visualizing and understanding better**}\  } `$, I adapted the topology to an imaginary company of my own creation. Removing some of the parts and just focusing on devices, lines and locations:
