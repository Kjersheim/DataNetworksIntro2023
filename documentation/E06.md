...
In the end, I need to find a type of router that would fit. Though obviously I need to look towards enterprise type routers. The reason is that even though a home router might work for the WIFI, literally every workstation will go through the router - since the chilinetwork is world-wide. 
From what I understand enterprise routers are faster(in itself, not internet-speed-fast), more stable and have better security. Being able to configure, add static routes and if needed having more physical ports would be a bonus. 
...
![](/documentation/E06/Router2.png)
 
 
 Having already chosen Cisco switches, the last open I checked out was Cisco 867VAE. It might be overkill compared to the previous alternatives, 
...
To connect with the chili-community a modem is required. Not knowing much about them, and despite remembering the dial up sounds from the early 90s, 
modems in my mind today is a part of the router and accesspoint I have next to my tv, plugged in the wall.
I have not yet really found any options, as I feel modems are mostly a part of other devices like routers and alike these days. 
I find alot of mobile-broadband routers and such which I have used before for certain OSINT-tasks.

Still throughout the search I start thinking that I need to get a connection between my fiber intake and one of my routers. 
The above routers would handle that, but the question remains if I should settle with the fiber box or get a modem. I think I need some more input and time to check this part out. 
