...
The first option I landed on: MikroTik Cloud Core Router CCR1009-7G-1C-PC
...
Another option could be the more simple Linksys LRT214, single WAN at half price of double. I dont see a reason why we would need multiple internet connections at this point
 ...
 A third option could be the Mikrotiks RB2011iL-IN, a much more affordable - though then again more limited router. About 100 € per.
...
To connect with the chili-community a modem is required. Not knowing much about them, and despite remembering the dial up sounds from the early 90s, modems in my mind today is a part of the router and accesspoint I have next to my tv, plugged in the wall. I have not yet really found any options, as I 
