...
Previously I do have some experience in patching, and having had physical access and a decent control over my last employers "Data room". From there I was aware over the different devices, 
interconnection between parts, additions of routers from different operators and such. 
...
The closest actual computer-educated person were 220km away, and they rarely visited. I would post a picture of the cabinets/racks but.. it was not a good example as no one did the maintainance nor had a sense of cable management!
...
(seeing that the contents of the data-room was definitely not my field of work, though we needed access since things happend - aaall the time), was to switch the wooden door to an armored steel door!
